...
const targetJsonPath = resolve(workspaceRoot, "assets", "productIcons", "mkProductIcons.json");
const targetFontPath = resolve(workspaceRoot, "assets", "productIcons", "mkProductIcons.ttf");
