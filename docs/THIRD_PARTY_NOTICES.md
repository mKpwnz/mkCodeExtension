...
- Usage: adapted into `themes/mk-theme-dark-color-theme.json`.
- Modification notice: JetBrains theme and editor scheme values were mapped to VS Code
  workbench colors, TextMate token colors, and semantic token colors.
